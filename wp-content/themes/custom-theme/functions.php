...
function documents_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'documents widget', 'custom-theme' ),
			'id'            => 'documents-1',
			'description'   => esc_html__( 'Add widgets here.', 'custom-theme' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
...
add_action( 'widgets_init', 'documents_widgets_init' );
...
function footer_widgets1_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'footer widget 1', 'custom-theme' ),
			'id'            => 'footer-1',
			'description'   => esc_html__( 'Add widgets here.', 'custom-theme' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
...
function footer_widgets2_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'footer widget 2', 'custom-theme' ),
			'id'            => 'footer-2',
			'description'   => esc_html__( 'Add widgets here.', 'custom-theme' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
...
function footer_widgets3_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'footer widget 3', 'custom-theme' ),
			'id'            => 'footer-3',
			'description'   => esc_html__( 'Add widgets here.', 'custom-theme' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
...
function footer_widgets4_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'footer widget 4', 'custom-theme' ),
			'id'            => 'footer-4',
			'description'   => esc_html__( 'Add widgets here.', 'custom-theme' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
...
// }
function custom_theme_scripts() {
	wp_enqueue_style( 'fontIcons', get_template_directory_uri() . '/assets/css/all.min.css' );
    wp_enqueue_style( 'bootstrapCss', get_template_directory_uri() . '/assets/css/bootstrap.min.css' );
    wp_enqueue_style( 'root-theme', get_stylesheet_uri() );
	wp_enqueue_script( 'bootstrap-js', get_template_directory_uri() . '/assets//js/bootstrap.bundle.min.js', array(), '3.0.0', true );
	wp_enqueue_script( 'jquery-js', get_template_directory_uri() . '/assets//js/jquery.min.js', array(), '3.0.0', true );
	wp_enqueue_script( 'custom-js', get_template_directory_uri() . '/assets//js/custom.js', array(), '3.0.0', true );
}
...
function create_posttype() {
	...
	'singular_name' => _x('documents-details', 'singular'),
